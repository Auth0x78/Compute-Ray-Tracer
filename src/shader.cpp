...
Shader::Shader(const char *vertexFile, const char *fragmentFile) {
  shaderType = GL_VERTEX_SHADER; // When shaderType is Vertex then Fragment is
                                 // also assumed
...
void Shader::compileShader(const char *vertexFile, const char *fragmentFile) {
  ...
  parsePreprocessorDirectives(fragmentCode,
                              get_directory_from_path(fragmentFile));
...
void Shader::parsePreprocessorDirectives(std::string &source,
        ...
        if (directive[j] == '\"') {
          ...
          if (end != std::string::npos) {
            std::string includeFile =
                parentDir + directive.substr(start, end - start);
            ...
            parsePreprocessorDirectives(
                includeCode, get_directory_from_path(includeFile.c_str()));
